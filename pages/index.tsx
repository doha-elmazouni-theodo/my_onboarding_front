      ...
      <section className="text-gray-600 body-font">
        <div className="container px-5 py-24 mx-auto">
          ...
          <div className="flex flex-wrap justify-center">
            ...
            >
              Le produit ne doit pas présenter de bugs impactant l'expérience
              utilisateur.
            </Banner3S>
            <Banner3S
              title="Security"
            ...
            >
              Le produit doit être prémunis contre les vulnérabilités les plus
              communes.
            </Banner3S>
            <Banner3S
              title="Speed"
            ...
            >
              Le produit doit être au standard sur la performance. Ca inclut la
              vitesse de chargement et la scalabilité.
            </Banner3S>
          </div>
        </div>
      </section>
